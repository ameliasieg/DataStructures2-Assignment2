...
class isOdd // Functor is just a function name
{
	public:
    ...
    // TO BE FILLED
	// A function in the class isOdd which will be used as a functor to return a bool value, 
	// true if an integer input variable is odd, and false otherwise
...
class LongerThanFive
{
	public:
    // TO BE FILLED
	// A function in the class LongerThanFive which will be used as a functor to return a bool value, 
	// true if a string input variable's length is > 5, and false otherwise
